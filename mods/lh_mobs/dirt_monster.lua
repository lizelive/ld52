...
mobs:register_mob("lh_mobs:dirt_monster", {
	type = "monster",
	passive = false,
...
mobs:register_egg("lh_mobs:dirt_monster", S("Dirt Monster"), "default_dirt.png", 1)


mobs:alias_mob("mobs:dirt_monster", "lh_mobs:dirt_monster") -- compatibility
