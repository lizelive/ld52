...
mobs:register_mob("lh_mobs:dungeon_master", {
	type = "monster",
	passive = false,
	damage = 6,
...
mobs:register_egg("lh_mobs:dungeon_master", S("Dungeon Master"), "fire_basic_flame.png", 1, true)


mobs:alias_mob("mobs:dungeon_master", "lh_mobs:dungeon_master") -- compatibility


-- fireball (weapon)
mobs:register_arrow("lh_mobs:fireball", {
	visual = "sprite",
	visual_size = {x = 1, y = 1},
