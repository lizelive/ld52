...
mobs:register_mob("lh_mobs:tree_monster", {
	type = "monster",
	passive = false,
...
mobs:register_egg("lh_mobs:tree_monster", S("Tree Monster"), "default_tree_top.png", 1)


mobs:alias_mob("mobs:tree_monster", "lh_mobs:tree_monster") -- compatibility
