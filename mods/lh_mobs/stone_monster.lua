...
mobs:register_mob("lh_mobs:stone_monster", {
	type = "monster",
	passive = false,
...
mobs:register_egg("lh_mobs:stone_monster", S("Stone Monster"), "default_stone.png", 1)


mobs:alias_mob("mobs:stone_monster", "lh_mobs:stone_monster") -- compatibility
