...
mobs:register_mob("lh_mobs:spider", {
	--docile_by_day = true,
	group_attack = true,
	type = "monster",
	passive = false,
...
mobs:register_egg("lh_mobs:spider", S("Spider"), "mobs_cobweb.png", 1)


mobs:alias_mob("lh_mobs:spider2", "lh_mobs:spider") -- compatibility
mobs:alias_mob("mobs:spider", "lh_mobs:spider")
...
mobs:register_arrow("lh_mobs:cobweb", {
	visual = "sprite",
	visual_size = {x = 1, y = 1},
