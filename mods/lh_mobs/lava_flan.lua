...
mobs:register_mob("lh_mobs:lava_flan", {
	type = "monster",
	passive = false,
	...
	on_die = function(self, pos)
		...
		if def and def.groups and def.groups.water then
			...
			if math.random(4) == 1 then
				mobs:add_mob(pos, {name = "lh_mobs:obsidian_flan"})
			end
		else
...
-- add spawn egg
mobs:register_egg("lh_mobs:lava_flan", S("Lava Flan"), "default_lava.png", 1)


-- compatibility alias, only needed for servers who used the old mobs mod
mobs:alias_mob("mobs:lava_flan", "lh_mobs:lava_flan")
...
mobs:register_mob("lh_mobs:obsidian_flan", {
	type = "monster",
	passive = false,
	attack_type = "shoot",
	shoot_interval = 0.5,
	shoot_offset = 1.0,
	arrow = "lh_mobs:obsidian_arrow",
	reach = 2,
	damage = 3,
	hp_min = 10,
	hp_max = 35,
...
-- add spawn egg
mobs:register_egg("lh_mobs:obsidian_flan", S("Obsidian Flan"),
...
-- mese arrow (weapon)
mobs:register_arrow("lh_mobs:obsidian_arrow", {
	visual = "sprite",
