...
mobs:register_mob("lh_mobs:mese_monster", {
	type = "monster",
...
--[[
		...
		for i, obj in ipairs(objects) do
			...
			and obj:get_wielded_item():get_name() == "lh_mobs:mese_monster" then
...
-- mese arrow (weapon)
minetest.register_craftitem("lh_mobs:mese_crystal_fragment_arrow", {
...
mobs:register_arrow("lh_mobs:mese_arrow", {
	visual = "wielditem",
	visual_size = {x = 0.25, y = 0.25},
	textures = {"lh_mobs:mese_crystal_fragment_arrow"},
	velocity = 8,
	rotate = 180,
	damage = 2,
...
mobs:register_egg("lh_mobs:mese_monster", S("Mese Monster"), "default_mese_block.png", 1)


mobs:alias_mob("mobs:mese_monster", "lh_mobs:mese_monster") -- compatiblity
