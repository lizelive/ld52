...
mobs:register_mob("lh_mobs:sand_monster", {
	type = "monster",
	passive = false,
...
mobs:register_egg("lh_mobs:sand_monster", S("Sand Monster"),
		"default_desert_sand.png", 1)


mobs:alias_mob("mobs:sand_monster", "lh_mobs:sand_monster") -- compatibility
