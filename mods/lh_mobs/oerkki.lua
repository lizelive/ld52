...
mobs:register_mob("lh_mobs:oerkki", {
	type = "monster",
	passive = false,
...
mobs:register_egg("lh_mobs:oerkki", S("Oerkki"), "default_obsidian.png", 1)


mobs:alias_mob("mobs:oerkki", "lh_mobs:oerkki") -- compatiblity
