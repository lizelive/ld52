...
if minetest.get_translator ~= nil then
	S = minetest.get_translator("scyther_mobs") -- 5.x translation function
else
...
mobs:alias_mob("scyther_mobs:tank", "scyther_mobs:dungeon_master")
mobs:alias_mob("scyther_mobs:spore", "scyther_mobs:tree_monster")
